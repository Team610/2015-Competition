...
public class ElectricalConstants {
	...
	//ALL UNTESTED
	public static final int PDP_LEFTROLLER_CHANNEL = 4;
	public static final int PDP_RIGHTROLLER_CHANNEL = 5;
	public static final int PDP_ELEVATOR_CHANNEL = 2;
	...
	public static final int BUMPER_SOLENOID_ARM1 = 6;
	public static final int BUMPER_SOLENOID_ARM2 = 7;
	public static final int BUMPER_SOLENOID_WING1 = 4;
	public static final int BUMPER_SOLENOID_WING2 = 5;
