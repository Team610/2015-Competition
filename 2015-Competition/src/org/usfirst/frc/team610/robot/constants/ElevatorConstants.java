...
public class ElevatorConstants {
	...
	public static final int carryingBinUp = 0;
	public static final int carryingBinDown = 1;
	public static final int carryingTote = 2;
	...
	public static final double ELEVATOR_TOP = 0.074; // 0.084 new top

	// Totes
	public static final double ELEVATOR_TOTEPICKUP = 0.809;
	public static final double ELEVATOR_TOTECARRYING = 0.765;
	public static final double ELEVATOR_ONETOTES = 0.661;
	public static final double ELEVATOR_TWOTOTES = 0.468;
	public static final double ELEVATOR_THREETOTES = 0.322;
	public static final double ELEVATOR_FOURTOTES = 0.187;
	public static final double ELEVATOR_FIVETOTES = 0.074;
	...
	// Bins Lying Down
	public static final double ELEVATOR_BINPICKUP_DOWN = 0.809; // real bottom
																// 0.89
	...
	public static final double ELEVATOR_FIVEBINS_DOWN = 0.074;
