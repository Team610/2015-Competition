...
public class Bumper extends Subsystem {
	...
	//PDP in order to check the current to the winch, to prevent the motor from stalling
    ...
    //Method to change position of the arms, if position is true, bring the arms up. If false, set the arms down
    ...
    //Method to change position of the wings, if position is true, bring the wings up. If false, set the arms down
    ...
    public void setWinch(double distance){
    	...
    	if(pdp.getCurrent(ElectricalConstants.PDP_WINCH_CHANNEL) > 10){
